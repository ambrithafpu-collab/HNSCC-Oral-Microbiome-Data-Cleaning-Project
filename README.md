...
This project focuses on preparing microbiome data to enable meaningful biological insights.
...
* Imported raw microbiome dataset using Python

### 2. Data Cleaning

* Removed missing values
* Eliminated inconsistencies in the dataset

### 3. Data Preprocessing

* Structured and formatted data for analysis
* Ensured uniform data representation
...
* Reduced noise and inconsistencies in raw data
...
* Statistical analysis of microbial patterns
* Comparative analysis between healthy and HNSCC samples
